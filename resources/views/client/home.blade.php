                    ...
                    <div class="row">
                        <div class="col-md-6 align-self-center">
                            <div class="p-4" data-aos="fade-up">
                                <h2 class="text-primary title-2 display-4">
                                    What Is <br />
                                    Thorsiq Token
                                </h2>
                                <p>
                                    THORSIQ provides the necessary place to enter IDO & private sales. Easy investment management in the cryptocurrency market and creating a financing plan that is profitable for everyone and safe for
                                    investors
                                </p>
                ...
                <div class="row row-cols-1 row-cols-md-2 g-4">
                    ...
                    <a href="{{ route('member.lottery') }}" class="col no-dec">
                        <div class="card bg-dark-2 text-white rising" data-aos="fade-up" data-aos-delay="100">
                            ...
                            <div class="card-body">
                                <h5 class="card-title title-2 text-primary">Lottery<i class="ms-2 bi bi-caret-right-fill"></i></h5>
                            </div>
                        </div>
                    </a>
                </div>
...
<div class="position-relative">
    <section class="space-m" style="z-index: 1;">
        <div class="container">
                        ...
                        <ul class="list-group list-group-flush list-road">
                            <li class="list-group-item">
                                <div class="media">
                                    ...
                                    <div class="media-body">Use Case and MVP Development</div>
                                </div>
                            </li>
                            <li class="list-group-item">
                                <div class="media">
                                    <i class="bi bi-check-circle-fill me-3 text-primary"></i>
                                    <div class="media-body">THORSIQ  Token Development and Private Sale</div>
                                </div>
                            </li>
                            <li class="list-group-item">
                                <div class="media">
                                    <i class="bi bi-check-circle-fill me-3 text-primary"></i>
                                    <div class="media-body">THORSIQ Website With MVP Release</div>
                                </div>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="mb-roadmap-block card">
                        ...
                        <ul class="list-group list-group-flush list-road">
                            <li class="list-group-item">
                                <div class="media">
                                    <i class="bi bi-check-circle-fill me-3 text-primary"></i>
                                    <div class="media-body">Presale & Public Sale On DEX</div>
                                </div>
                            </li>
                            <li class="list-group-item">
                                <div class="media">
                                    <i class="bi bi-dash-circle me-3 text-primary"></i>
                                    <div class="media-body">THORSIQ LOTTREY Game Release</div>
                                </div>
                            </li>
                            <li class="list-group-item">
                                <div class="media">
                                    <i class="bi bi-dash-circle me-3 text-primary"></i>
                                    <div class="media-body">Build Launchpad NFT</div>
                                </div>
                            </li>
                            <li class="list-group-item">
                                <div class="media">
                                    <i class="bi bi-dash-circle me-3 text-primary"></i>
                                    <div class="media-body">Token & NFT Project Security Book Launch</div>
                                </div>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="mb-roadmap-block card">
                        ...
                        <ul class="list-group list-group-flush list-road">
                            <li class="list-group-item">
                                <div class="media">
                                    <i class="bi bi-dash-circle me-3 text-primary"></i>
                                    <div class="media-body">NFT Launchpad Release</div>
                                </div>
                            </li>
                            <li class="list-group-item">
                                <div class="media">
                                    <i class="bi bi-dash-circle me-3 text-primary"></i>
                                    <div class="media-body">Coingecko & Coimarketcap Release</div>
                                </div>
                            </li>
                            <li class="list-group-item">
                                <div class="media">
                                    <i class="bi bi-dash-circle me-3 text-primary"></i>
                                    <div class="media-body">THORSIQ Staking Platfrom</div>
                                </div>
                            </li>
                            <li class="list-group-item">
                                <div class="media">
                                    <i class="bi bi-dash-circle me-3 text-primary"></i>
                                    <div class="media-body">New Staking Tiers</div>
                                </div>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="mb-roadmap-block card">
                        ...
                        <ul class="list-group list-group-flush list-road">
                            <li class="list-group-item">
                                <div class="media">
                                    <i class="bi bi-dash-circle me-3 text-primary"></i>
                                    <div class="media-body">Governance Model</div>
                                </div>
                            </li>
                            <li class="list-group-item">
                                <div class="media">
                                    <i class="bi bi-dash-circle me-3 text-primary"></i>
                                    <div class="media-body">Financial Result Report</div>
                                </div>
                            </li>
                            <li class="list-group-item">
                                <div class="media">
                                    <i class="bi bi-dash-circle me-3 text-primary"></i>
                                    <div class="media-body">New Feature Launch</div>
                                </div>
                            </li>
                        </ul>
                    </div>
            ...
            <div class="space-m">
                <h2 class="text-primary text-center title-2 mb-4">Suporting Roadmaps</h2>
                <div class="row">
                    <div class="col-md-10 offset-md-1">
                        <div class="row">
                            <div class="col-md mb-4 mb-sm-0">
                                <div class="card bg-dark-2 h-100" data-aos="fade-up">
                                    <div class="card-body">
                                        <p class="text-primary border-0 text-phase">Phase 1</p>
                                        <ul class="list-group list-group-flush list-road">
                                            <li class="list-group-item">
                            ...
                            <div class="col-md mb-4 mb-sm-0">
                                <div class="card bg-dark-2 h-100" data-aos="fade-up" data-aos-delay="50">
                                    <div class="card-body">
                                        <p class="text-primary border-0 text-phase">Phase 2</p>
                                        <ul class="list-group list-group-flush list-road">
                                            <li class="list-group-item">
                                                <div class="media">
                                                    <i class="bi bi-dash-circle me-3 text-primary"></i>
                                                    <div class="media-body">
                                                        Approach to NFT & Token Project Developer
                                                    </div>
                                                </div>
                                            </li>
                                            <li class="list-group-item">
                            ...
                            <div class="col-md">
                                <div class="card bg-dark-2 h-100" data-aos="fade-up" data-aos-delay="100">
                                    <div class="card-body">
                                        <p class="text-primary border-0 text-phase">Phase 3</p>
                                        <ul class="list-group list-group-flush list-road">
                                            <li class="list-group-item">
                ...
                <div class="card bg-dark border-0 border-top border-primary" data-aos="fade-up">
                    <div class="card-body">
                        ...
                        <ul class="list-group list-group-flush list-road-2">
                            ...
                            <li class="list-group-item">3% marketing</li>
                        </ul>
                    </div>
                </div>
...
<section class="space-m bg-dark-2">
    <div class="container">
    <h2 class="text-primary title-2 text-center mb-4">Partnership</h2>
    <div class="row">
    <div class="col-md-6 offset-md-3">
    <div class="row">
        <div class="col-md-6">
            <img src="{{ asset('img/asu.jpeg') }}" alt="" width="100%" class="rounded" data-aos="fade-up">
        </div>
        <div class="col-md-6">
            <img src="{{ asset('img/soloo.jpg') }}" alt="" width="100%" class="rounded" data-aos="fade-up" data-aos-delay="50">
        </div>
    </div>
    </div>
    </div>
                    ...
                    <div class="accordion-item border-dark">
                        ...
                        <div id="flush-collapseOne" class="accordion-collapse collapse" aria-labelledby="flush-headingOne" data-bs-parent="#accordionFaq">
                            <div class="accordion-body bg-dark">
                                Allows investors to sell a small portion of their assets to raise capital and fund growth. The Company is tokenized through the TIG Protocol and registered on the Platform. They can buy and sell any number of
                                tokens depending on their current financial situation and cash flow. Also, the Protocol gives him the opportunity to buy back all the tokens.
                            </div>
                        </div>
                    </div>
                    <div class="accordion-item border-dark">
                        ...
                        <div id="flush-collapseTwo" class="accordion-collapse collapse" aria-labelledby="flush-headingTwo" data-bs-parent="#accordionFaq">
                            <div class="accordion-body bg-dark">
                                Will offer dozens of VC opportunities at home and abroad without excessive restrictions or expensive transaction fees. Through TIG, investors can have exposure to early stages across multiple geographies and
                                sectors. TIG will offer start-ups in immature markets the opportunity to reach their full potential, while potentially providing investors with profitable returns.
                            </div>
                        </div>
                    </div>
                    <div class="accordion-item border-dark">
                        ...
                        <div id="flush-collapseThree" class="accordion-collapse collapse" aria-labelledby="flush-headingThree" data-bs-parent="#accordionFaq">
                            <div class="accordion-body bg-dark">
                                Part of the reason TIG exists is to help struggling retail investors access the exclusive world of VC. With TIG, investors find out the best options available to them through the online Platform. They
                                selected several startups in Asia as well as globally, directly purchased their tokens from the secondary market within the Platform, and now have a diversified portfolio. The retail investor completes this
                                miraculous transaction within an hour without having to bother with all the paperwork and legal issues he would have faced otherwise. They can sell their tokens at any time in the secondary market after
                                getting the return on their investment.
                            </div>
                        </div>
                    </div>
                    <div class="accordion-item border-dark">
                        ...
                        <div id="flush-collapseFour" class="accordion-collapse collapse" aria-labelledby="flush-headingFour" data-bs-parent="#accordionFaq">
                            <div class="accordion-body bg-dark">
                                Make your funds continue to grow both from the value of TIG assets, to Startup Funding. The value of TIG will continue to increase from year to year following the number of startups invested, both from
                                investments in the NFT field and various tokens and coins in all blockchain chains.
                            </div>
                        </div>
                    </div>
                </div>
